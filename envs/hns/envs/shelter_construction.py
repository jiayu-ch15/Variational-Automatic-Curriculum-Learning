...
def ShelterConstructionEnv(args, n_substeps=15, horizon=200, deterministic_mode=False,
             floor_size=2.0, grid_size=15,
             n_agents=1,
             objective_diameter=[1, 1], objective_placement='center',
             num_rays_per_side=25, shelter_reward_scale=0.01,

...
from envs.hns.modules import EnvModule, rejection_placement, rejection_placement_box, rejection_placement_ramp, get_size_from_xml
        ...
        for i in range(self.curr_n_boxes):
            ...
            if self.placement_fn is not None:
                ...
                if 'set_box_state' in env.metadata:# box_locking
                    pos, _  = rejection_placement_box(env, i, _placement_fn, floor_size, self.box_size_array[i, :2])
                else:
        ...
        for i in range(self.n_ramps):
            ...
            if self.placement_fn is not None:
                ...
                if 'set_ramp_state' in env.metadata:
                    pos, _  = rejection_placement_ramp(env, i, _placement_fn, floor_size, get_size_from_xml(geom))
                else:

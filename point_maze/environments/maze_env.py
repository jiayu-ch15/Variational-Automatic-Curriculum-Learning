...
from point_maze.environments import maze_env_utils

# Directory that contains mujoco xml files.
MODEL_DIR = os.path.join(os.path.dirname(__file__), 'assets')
# MODEL_DIR = os.path.join(os.path.expanduser("~"), 'projects/simple_rl/tasks/point_maze/environments/assets')
...
class MazeEnv(gym.Env):
  ...
  def reset(self):
    ...
    while self._is_in_collision(self._get_obs()[:2]):
        self.wrapped_env.reset()

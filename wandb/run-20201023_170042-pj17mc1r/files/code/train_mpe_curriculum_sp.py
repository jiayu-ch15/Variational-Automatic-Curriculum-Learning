...
class node_buffer():
    ...
    def SampleNearby_novelty(self, parents, child_novelty_threshold, writer, timestep): # produce high novelty children and return 
        ...
        wandb.log({'novelty_threshold': novelty_threshold},timestep)
        parents = parents + []
    ...
    def move_nodes(self, one_length, Rmax, Rmin, use_child_novelty, use_parent_novelty, child_novelty_threshold, del_switch, writer, timestep): 
        ...
        wandb.log({'archive_length': len(self.archive)},timestep)
        wandb.log({'childlist_length': len(self.childlist)},timestep)
        wandb.log({'parentlist_length': len(self.parent)},timestep)
        wandb.log({'drop_num': drop_num},timestep)

    ...
    for episode in range(episodes):
        ...
        for times in range(eval_frequency):
            ...
            if args.share_policy:
                ...
                for agent_id in range(num_agents):
                    role = 'speaker' if agent_id == 0 else 'listener'
                    actor_critic[agent_id].train()
                    value_loss, action_loss, dist_entropy = agents[agent_id].update_single(agent_id, role, rollouts[agent_id],current_timestep)

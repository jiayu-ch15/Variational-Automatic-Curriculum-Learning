...
num_landmarks=4
num_agents=4
algo="sp_eval3_minibatch8_wo_accumulate_grad_lr1e-3"
# algo='check'
seed=1
...
# done
CUDA_VISIBLE_DEVICES=2 python train_mpe_curriculum_sp.py --env_name ${env} --algorithm_name ${algo} --scenario_name ${scenario} --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed ${seed} --n_rollout_threads 500 --num_mini_batch 8 --episode_length 70 --num_env_steps 40000000 --ppo_epoch 15 --recurrent_policy --use_popart --lr 1e-3 # --use_accumulate_grad --use_grad_average

...
num_landmarks=4
num_agents=4
algo="disagreement_map2_easy06_critick3_true"
# algo='check'
seed=1
...
# done
CUDA_VISIBLE_DEVICES=1 python train_mpe_disagreement_sp.py --env_name ${env} --algorithm_name ${algo} --scenario_name ${scenario} --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed ${seed} --n_rollout_threads 500 --num_mini_batch 2 --episode_length 70 --num_env_steps 60000000 --ppo_epoch 15 --recurrent_policy --use_popart --multi_critic

...
def main():
    ...
    save_dir = './' + scenario + '/'
    save_name = 'main_results_sp_4agents'
    ...
    # exp_name = 'sp_uniform_from_activeAndsolve'
    # # data_dir =  './' + exp_name + '.csv'
    # x_step1 = []
    # y_seed1 = []
    # x_step2 = []

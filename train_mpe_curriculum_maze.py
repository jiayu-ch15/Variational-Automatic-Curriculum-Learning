...
import pdb
import wandb
from point_maze.environments.point_maze_env import PointMazeEnv
...
def main():
    args = get_config()
    run = wandb.init(project='maze',name=str(args.algorithm_name) + "_seed" + str(args.seed))
    ...
    envs = PointMazeEnv(**gym_mujoco_kwargs)
    pdb.set_trace()

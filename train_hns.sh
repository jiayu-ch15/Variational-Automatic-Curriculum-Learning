...
algo='hns_h1_woPC_eval1_step1_wointclip_middlestep_init1000'
seed=1
...
--buffer_length 2000 --epsilon 1 --delta 1 --sol_prop 0.05 --B_exp 200 --h 1 --archive_initial_length 1000 --use_wandb

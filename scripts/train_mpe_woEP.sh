...
# simple spread
# CUDA_VISIBLE_DEVICES=1 python train_mpe_woEP.py --env_name ${env} --algorithm_name ${algo} --scenario_name ${scenario} --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed ${seed} --n_rollout_threads 2 --num_mini_batch 2 --episode_length 70 --num_env_steps 60000000 --ppo_epoch 15 --recurrent_policy --use_popart --lr 5e-4 --use_accumulate_grad \
# --buffer_length 2000 --epsilon 0.6 --delta 0.6 --sol_prop 0.05 --archive_initial_length 500 --B_exp 150


# hard spread
# CUDA_VISIBLE_DEVICES=0 python train_mpe_woEP.py --env_name ${env} --algorithm_name ${algo} --scenario_name ${scenario} --num_agents ${num_agents} --num_landmarks ${num_landmarks} --seed ${seed} --n_rollout_threads 10 --num_mini_batch 2 --episode_length 70 --num_env_steps 100000000 --ppo_epoch 15 --recurrent_policy --use_popart --lr 5e-4 --use_accumulate_grad \
...
--buffer_length 2000 --epsilon 0.4 --delta 0.4 --h 1 --archive_initial_length 500 --B_exp 150 
# --use_wandb

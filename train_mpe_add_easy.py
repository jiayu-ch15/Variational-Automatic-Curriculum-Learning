...
def produce_uniform_case(num_case,boundary,num_agents):
    one_starts_landmark = []
    one_starts_agent = []
    archive = [] 
...
def main():
    ...
    for episode in range(episodes):
        ...
        starts_easy = produce_uniform_case(num_easy,boundary_easy,num_agents)
        starts_uniform = produce_uniform_case(num_uniform,boundary,num_agents)

...
if __name__ == '__main__':
    ...
    # # uniform data
    # # map 2*2
    # boundary = {'agent':{'x':[[-1,1]],
    #     'y': [[-1,1]]},
    #     'landmark':{'x':[[-1,1]],
    #     'y': [[-1,1]]}}
    # starts = produce_uniform_case_H(10000, 4, boundary)
    # with open('/home/tsing73/curriculum/node_data/sp_22_4.txt','w') as fp:
    ...
    if args.scenario_name=='simple_spread' or args.scenario_name=='simple_spread_H':
        data_dir = '/home/tsing73/curriculum/node_data/sp_22_%i.txt' %agent_num
    ...
    j = 0
    while j<=1000:
        dir_path = mode_path  / 'starts' / ('starts_' + str(j))
        ...
        if os.path.exists(dir_path):
            ...
            if archive.shape[0]!=0:
                ...
                plt.savefig(mode_path / 'starts' / ('result_%i.jpg'%j))
        j += 1

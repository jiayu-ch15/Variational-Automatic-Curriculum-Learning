...
from algorithm.model import Policy,Policy3, ATTBase_add, ATTBase_actor_dist_add, ATTBase_critic_add, ATTBase_actor_homework
...
def main():
    args = get_config()
    run = wandb.init(project='homework',name=str(args.algorithm_name) + "_seed" + str(args.seed))
    ...
    if args.share_policy:
        actor_base = ATTBase_actor_homework(envs.observation_space[0].shape[0], envs.action_space[0], num_agents)
